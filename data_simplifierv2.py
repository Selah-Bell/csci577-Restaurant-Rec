...
def main():
    ...
    for filename in filenames:
        with open("clean_data/" + filename + ".cleaned", "r") as in_file, open("simple_datav2/" + filename + ".simple", "w") as out_file:
            for line in in_file:
                cur_line = line.split("\t")
    ...
    with open("simple_datav2/user_data_key", "w") as data_key:
        for user in unique_users:
            ...
            data_key.write("\n")
    with open("simple_datav2/event_data_key", "w") as data_key:
